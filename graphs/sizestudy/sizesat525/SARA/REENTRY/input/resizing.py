...
def transformer_dimension(valeur_str):
    ...
    nouvelle_valeur = valeur * 0.585
    return f"{nouvelle_valeur:.3f}"

# Charger le fichier XML original.
tree = ET.parse("sizesat525/SARA/REENTRY/input/objects_fullsize.xml")
root = tree.getroot()
...
tree.write("sizesat525/SARA/REENTRY/input/objects_transformed.xml", encoding="UTF-8", xml_declaration=True)
