...
data = data[["Velocity (km/s)", "Altitude (km)"]]

# Enregistrement du DataFrame dans un fichier CSV
data.to_csv("case1_DRAMA_velocity_altitude.csv", index=False)

print("Les résultats ont été enregistrés dans le fichier case1_DRAMA_velocity_altitude.csv")
