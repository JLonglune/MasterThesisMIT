...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -sara.Impact-Locations3D-CloseUp.gnu-  
#                           runID: sara				   
...
set output 'sara.Impact-Locations3D-CloseUp.png'
splot [] [] [0.0:] \
'/Applications/DRAMA-3.1.1/TOOLS/SARA/RISK/data/shores.plt' u 1:2:(0.0) notitle with lines lt -1 lw 1,\
'sara.Impact-Locations.dat' using 2:1:(0.0) with points pt 1 ps 3 lw 2 lt 1
