...
parent = pd.read_csv("BreakUP0.1/Downrange/NEQ_parent.csv")
case3_solid = pd.read_csv("BreakUP0.1/Downrange/NEQ_case3_solid.csv")
case3_hollow = pd.read_csv("BreakUP0.1/Downrange/NEQ_Case3_hollow.csv")
case4_solid = pd.read_csv("BreakUP0.1/Downrange/NEQ_Case4_solid.csv")
case4_hollow = pd.read_csv("BreakUP0.1/Downrange/NEQ_Case4_hollow.csv")
