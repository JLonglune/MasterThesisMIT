...
tree = etree.parse("BreakUP0.28NEQ/BreakUP_DRAMA/subsystems_database.xml")
root = tree.getroot()

plotter = pv.Plotter(shape=(2, 2))  # 2x2 vues

for i, mode in enumerate(["transparent", "clipped", "wireframe", "internal"]):
