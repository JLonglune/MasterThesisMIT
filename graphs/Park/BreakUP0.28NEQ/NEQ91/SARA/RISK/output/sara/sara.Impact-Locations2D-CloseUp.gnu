...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -sara.Impact-Locations2D-CloseUp.gnu-  
#                           runID: sara				   
...
set output 'sara.Impact-Locations2D-CloseUp.png'
plot \
'/Applications/DRAMA-3.1.1/TOOLS/SARA/RISK/data/shores.plt' with l lt -1 lw 1,\
'sara.Impact-Locations.dat' using 2:1 with points pt 1 ps 2 lw 2 lt 1
