...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pf_1D-Fragment-5979b336-f02c-480c-bbb6-e169a31f7ca8.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal fatality prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-5979b336-f02c-480c-bbb6-e169a31f7ca8"															
set ylabel 'Fatality Prob.[-]'											
set ytics nomirror																
set yrange[0:] 
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pf_1D-Fragment-5979b336-f02c-480c-bbb6-e169a31f7ca8.png'														
plot 'PySara.Risk-Fragment-5979b336-f02c-480c-bbb6-e169a31f7ca8.dat' u 1:4 w boxes lt 01 lw 01 notitle	
