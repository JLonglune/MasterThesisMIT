...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pi_1D-Fragment-c988d9e3-614a-444d-9796-3923a809db8f.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal impact prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-c988d9e3-614a-444d-9796-3923a809db8f"															
set ylabel 'Impact Prob.[-]'											
set yrange[0:] 
set ytics nomirror																
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pi_1D-Fragment-c988d9e3-614a-444d-9796-3923a809db8f.png'														
plot 'PySara.Risk-Fragment-c988d9e3-614a-444d-9796-3923a809db8f.dat' u 1:2 w boxes lt 01 lw 01 notitle	
