...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pf_1D-Fragment-144ee139-a532-44f7-9291-b67a552d6be8.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal fatality prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-144ee139-a532-44f7-9291-b67a552d6be8"															
set ylabel 'Fatality Prob.[-]'											
set ytics nomirror																
set yrange[0:] 
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pf_1D-Fragment-144ee139-a532-44f7-9291-b67a552d6be8.png'														
plot 'PySara.Risk-Fragment-144ee139-a532-44f7-9291-b67a552d6be8.dat' u 1:4 w boxes lt 01 lw 01 notitle	
