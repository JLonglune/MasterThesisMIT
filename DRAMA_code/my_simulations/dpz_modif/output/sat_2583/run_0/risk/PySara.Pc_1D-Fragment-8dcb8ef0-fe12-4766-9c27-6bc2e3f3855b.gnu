...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pc_1D-Fragment-8dcb8ef0-fe12-4766-9c27-6bc2e3f3855b.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal casualty prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-8dcb8ef0-fe12-4766-9c27-6bc2e3f3855b"															
set ylabel 'Casualty Prob.[-]'											
set ytics nomirror																
set yrange[0:] 
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pc_1D-Fragment-8dcb8ef0-fe12-4766-9c27-6bc2e3f3855b.png'														
plot 'PySara.Risk-Fragment-8dcb8ef0-fe12-4766-9c27-6bc2e3f3855b.dat' u 1:3 w boxes lt 01 lw 01 notitle	
