...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pf_1D-Fragment-03b61fef-8e3c-4ac8-9a6a-f31f845465d1.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal fatality prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-03b61fef-8e3c-4ac8-9a6a-f31f845465d1"															
set ylabel 'Fatality Prob.[-]'											
set ytics nomirror																
set yrange[0:] 
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pf_1D-Fragment-03b61fef-8e3c-4ac8-9a6a-f31f845465d1.png'														
plot 'PySara.Risk-Fragment-03b61fef-8e3c-4ac8-9a6a-f31f845465d1.dat' u 1:4 w boxes lt 01 lw 01 notitle	
