...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pf_1D-Fragment-fa9558ee-ae76-48d8-82e6-cde76fd02986.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal fatality prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-fa9558ee-ae76-48d8-82e6-cde76fd02986"															
set ylabel 'Fatality Prob.[-]'											
set ytics nomirror																
set yrange[0:] 
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pf_1D-Fragment-fa9558ee-ae76-48d8-82e6-cde76fd02986.png'														
plot 'PySara.Risk-Fragment-fa9558ee-ae76-48d8-82e6-cde76fd02986.dat' u 1:4 w boxes lt 01 lw 01 notitle	
