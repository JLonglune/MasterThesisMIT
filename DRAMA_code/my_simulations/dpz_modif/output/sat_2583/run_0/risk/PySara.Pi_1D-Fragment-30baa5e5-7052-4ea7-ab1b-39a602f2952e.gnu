...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pi_1D-Fragment-30baa5e5-7052-4ea7-ab1b-39a602f2952e.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal impact prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-30baa5e5-7052-4ea7-ab1b-39a602f2952e"															
set ylabel 'Impact Prob.[-]'											
set yrange[0:] 
set ytics nomirror																
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pi_1D-Fragment-30baa5e5-7052-4ea7-ab1b-39a602f2952e.png'														
plot 'PySara.Risk-Fragment-30baa5e5-7052-4ea7-ab1b-39a602f2952e.dat' u 1:2 w boxes lt 01 lw 01 notitle	
