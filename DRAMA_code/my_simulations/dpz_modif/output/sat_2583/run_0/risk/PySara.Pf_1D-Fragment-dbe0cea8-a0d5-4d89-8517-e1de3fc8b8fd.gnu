...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pf_1D-Fragment-dbe0cea8-a0d5-4d89-8517-e1de3fc8b8fd.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal fatality prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-dbe0cea8-a0d5-4d89-8517-e1de3fc8b8fd"															
set ylabel 'Fatality Prob.[-]'											
set ytics nomirror																
set yrange[0:] 
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pf_1D-Fragment-dbe0cea8-a0d5-4d89-8517-e1de3fc8b8fd.png'														
plot 'PySara.Risk-Fragment-dbe0cea8-a0d5-4d89-8517-e1de3fc8b8fd.dat' u 1:4 w boxes lt 01 lw 01 notitle	
