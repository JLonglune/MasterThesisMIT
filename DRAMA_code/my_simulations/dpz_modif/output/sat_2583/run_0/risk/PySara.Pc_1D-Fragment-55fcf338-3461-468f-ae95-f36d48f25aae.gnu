...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pc_1D-Fragment-55fcf338-3461-468f-ae95-f36d48f25aae.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal casualty prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-55fcf338-3461-468f-ae95-f36d48f25aae"															
set ylabel 'Casualty Prob.[-]'											
set ytics nomirror																
set yrange[0:] 
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pc_1D-Fragment-55fcf338-3461-468f-ae95-f36d48f25aae.png'														
plot 'PySara.Risk-Fragment-55fcf338-3461-468f-ae95-f36d48f25aae.dat' u 1:3 w boxes lt 01 lw 01 notitle	
