...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pi_1D-Fragment-c45549b5-46ea-4348-a189-5decd51dbeb8.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal impact prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-c45549b5-46ea-4348-a189-5decd51dbeb8"															
set ylabel 'Impact Prob.[-]'											
set yrange[0:] 
set ytics nomirror																
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pi_1D-Fragment-c45549b5-46ea-4348-a189-5decd51dbeb8.png'														
plot 'PySara.Risk-Fragment-c45549b5-46ea-4348-a189-5decd51dbeb8.dat' u 1:2 w boxes lt 01 lw 01 notitle	
