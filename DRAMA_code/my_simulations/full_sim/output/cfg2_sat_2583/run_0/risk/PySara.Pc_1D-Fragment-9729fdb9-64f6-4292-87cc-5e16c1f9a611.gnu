...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pc_1D-Fragment-9729fdb9-64f6-4292-87cc-5e16c1f9a611.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal casualty prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-9729fdb9-64f6-4292-87cc-5e16c1f9a611"															
set ylabel 'Casualty Prob.[-]'											
set ytics nomirror																
set yrange[0:] 
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pc_1D-Fragment-9729fdb9-64f6-4292-87cc-5e16c1f9a611.png'														
plot 'PySara.Risk-Fragment-9729fdb9-64f6-4292-87cc-5e16c1f9a611.dat' u 1:3 w boxes lt 01 lw 01 notitle	
