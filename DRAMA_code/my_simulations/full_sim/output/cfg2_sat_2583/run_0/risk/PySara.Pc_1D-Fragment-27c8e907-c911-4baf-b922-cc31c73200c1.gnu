...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pc_1D-Fragment-27c8e907-c911-4baf-b922-cc31c73200c1.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal casualty prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-27c8e907-c911-4baf-b922-cc31c73200c1"															
set ylabel 'Casualty Prob.[-]'											
set ytics nomirror																
set yrange[0:] 
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pc_1D-Fragment-27c8e907-c911-4baf-b922-cc31c73200c1.png'														
plot 'PySara.Risk-Fragment-27c8e907-c911-4baf-b922-cc31c73200c1.dat' u 1:3 w boxes lt 01 lw 01 notitle	
