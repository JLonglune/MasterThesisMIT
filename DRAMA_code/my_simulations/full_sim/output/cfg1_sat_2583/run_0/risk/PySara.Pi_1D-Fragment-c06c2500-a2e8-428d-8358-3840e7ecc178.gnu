...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pi_1D-Fragment-c06c2500-a2e8-428d-8358-3840e7ecc178.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal impact prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-c06c2500-a2e8-428d-8358-3840e7ecc178"															
set ylabel 'Impact Prob.[-]'											
set yrange[0:] 
set ytics nomirror																
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pi_1D-Fragment-c06c2500-a2e8-428d-8358-3840e7ecc178.png'														
plot 'PySara.Risk-Fragment-c06c2500-a2e8-428d-8358-3840e7ecc178.dat' u 1:2 w boxes lt 01 lw 01 notitle	
