...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pc_1D-Fragment-7f5c3acb-06e7-447f-ab8b-621d492b9a50.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal casualty prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-7f5c3acb-06e7-447f-ab8b-621d492b9a50"															
set ylabel 'Casualty Prob.[-]'											
set ytics nomirror																
set yrange[0:] 
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pc_1D-Fragment-7f5c3acb-06e7-447f-ab8b-621d492b9a50.png'														
plot 'PySara.Risk-Fragment-7f5c3acb-06e7-447f-ab8b-621d492b9a50.dat' u 1:3 w boxes lt 01 lw 01 notitle	
