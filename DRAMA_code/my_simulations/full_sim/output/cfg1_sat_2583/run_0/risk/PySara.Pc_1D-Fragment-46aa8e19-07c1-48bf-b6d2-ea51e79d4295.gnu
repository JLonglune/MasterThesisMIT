...
#                               ESA July 2024                   
#                                                                               
#               gnuplot driver file -PySara.Pc_1D-Fragment-46aa8e19-07c1-48bf-b6d2-ea51e79d4295.gnu-  
#                           runID: PySara				   
...
set title "DRAMA-SERAM\nglobal casualty prob. for an uncontrolled, latitude-band-limited re-entry \nrun ID: PySara\n Results: Fragment-46aa8e19-07c1-48bf-b6d2-ea51e79d4295"															
set ylabel 'Casualty Prob.[-]'											
set ytics nomirror																
set yrange[0:] 
set mytics 4																		
set format y '%.1te%+02T'														
set output 'PySara.Pc_1D-Fragment-46aa8e19-07c1-48bf-b6d2-ea51e79d4295.png'														
plot 'PySara.Risk-Fragment-46aa8e19-07c1-48bf-b6d2-ea51e79d4295.dat' u 1:3 w boxes lt 01 lw 01 notitle	
